...
export const KPI_CARDS: KpiCard[] = [
  {
    ...
    tooltip: "Hammer $71k | Premium $9.8k | Fees $4.6k | Refunds -$1.2k",
    trend: "up",
  ...
  },
  {
    ...
    value: "76%",
    sub: "Reserve met & sold",
    trend: "down",
    delta: "-4% vs prev period",
    icon: Percent,
    accent: false,
  },
  {
    ...
    value: "1,204",
    sub: "88 new this period",
    trend: "up",
    delta: "+7% vs prev period",
    icon: Users,
    accent: false,
  },
  {
